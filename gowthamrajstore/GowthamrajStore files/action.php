				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							echo   
								'<input type="hidden" name="return" value="https://gowthamrajp06.000webhostapp.com/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="https://gowthamrajp06.000webhostapp.com/payment_success.php">
									<input type="hidden" name="cancel_return" value="https://gowthamrajp06.000webhostapp.com/cancel.php"/>
